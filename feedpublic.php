...
while ($row = $query->fetch(PDO::FETCH_ASSOC)) {
  ...
  if ($likesquery && ($likesquery_num_rows > 0) && $user_ok == true && $log_username != "") {
  ...
  } elseif ($user_ok == true && $log_username != "") {
    ...
    $likescount = '<h4 id="like_number_'.$photoid.'" class="number_likes">'.$likes.' likes</h4>';
  }
